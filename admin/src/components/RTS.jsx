...
// Import PDFs
import PDF1 from '../Pdf/2015-31.pdf';


// Sample data
const actsData = [
  { title: "RTS, 2015", size: "4 MB", file: PDF1 },
];
  ...
  return (
    <section className="max-w-6xl mx-auto p-6">
      ...
      {/* <div className="flex justify-center mt-6 space-x-2">
        ...
        <a
          href="https://grievances.maharashtra.gov.in/mr/citizens/login?redirect=%2Fmr%2Fpost-grievance%2Fadd" // 👉 Replace with your actual link
          target="_blank"
          rel="noopener noreferrer"
